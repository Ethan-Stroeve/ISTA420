...
select o.orderid, o.custid, o.empid, max(o.orderdate) from sales.orders o
where o.orderdate = 
...
select o.orderid, o.custid, o.empid, o.orderdate
	from sales.orders o where o.custid in
	(select top (1) with ties o1.custid from sales.orders o1 group by o1.custid 
     order by count(o1.orderid) desc);
